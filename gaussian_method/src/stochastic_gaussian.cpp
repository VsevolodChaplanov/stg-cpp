#include "kriging/stochastic_gaussian.hpp"
#include <set>
#include <vector>
    ...
    namespace {
        ...
        public:
            ...
            arma::SpMat<double> assemble_sym() {
                ...
                return arma::SpMat<double>(locations, std::move(values));
            }
        ...
        arma::SpMat<double> build_covariance_matrix(const IVarFun<1>& varfun, double cut_share, const PhysicalSpace& outspace) {
        ...
        arma::SpMat<double> build_covariance_matrix(const IVarFun<3>& varfun, double cut_share, const PhysicalSpace& outspace) {
            double threshold = cut_share * varfun.max_value();
