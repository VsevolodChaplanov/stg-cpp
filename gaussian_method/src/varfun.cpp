...
namespace stg::kriging {
    ...
    // ================================ 1
    GridVariance1::GridVariance1(PhysicalSpace space, std::vector<double>&& val) : _space(space),
                                                                                   _value(std::move(val)),
    ...
    GridVariance2::GridVariance2(PhysicalSpace space,
                                 ...
                                 std::vector<double>&& val22) : _space(space),
    ...
    GridVariance3::GridVariance3(PhysicalSpace space,
                                 ...
                                 std::vector<double>&& val33) : _space(space),
                                                                _value11(std::move(val11)),
                                                                _value12(std::move(val12)),
