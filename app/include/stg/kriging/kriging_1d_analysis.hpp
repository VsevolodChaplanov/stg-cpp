...
namespace stg::kriging {
    ...
    public:
        ...
        explicit KrigingAnalysis1D(DataLoader loader)
            : real_space_mesh_{loader.load_mesh<T>("r_11.vtk")}, fourier_space_mesh_{loader.load_mesh<T>("phi_11.vtk")}, covariations_{loader.load_scalar_data<T>("r_11.vtk")}, fert_values_{loader.load_scalar_data<T>("phi_11.vtk")}, velocity_samples_{loader.load_velocity_samples_1sg<T>()} {
