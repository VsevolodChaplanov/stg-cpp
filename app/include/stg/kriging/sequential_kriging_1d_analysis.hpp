...
namespace stg::kriging {
    ...
    public:
        ...
        explicit SequentialAnalysis(DataLoader loader, Params params)
            : loader_{std::move(loader)}, params_{std::move(params)}, velocity_mesh_(loader_.load_mesh<value_type>(
                                                                              fmt::format("sg1_L{}_N{}_eigcut{}_try{}.vtk", params_.L, params_.N, params_.eigen_cut, 0))),
              covariance_mesh_(loader_.load_mesh<value_type>("r_11.vtk")), covariations_{loader_.load_scalar_data<value_type>("r_11.vtk")} {
